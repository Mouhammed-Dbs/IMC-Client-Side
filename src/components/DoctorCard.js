...
export default function DoctorCard({ name, username, des, srcImg }) {
    ...
    return (
        <Card className="m-2 min-w-[200px] md:min-w-[350px] p-4">
            <CardHeader className="flex justify-center items-center gap-3">
                <div className="">
                    <Avatar isBordered radius="full" size="lg" src={srcImg} className="block m-auto" />
                    <div className="flex flex-col gap-1 items-center justify-end">
                        <h4 className="text-xl font-semibold leading-none text-default-600 mt-4" >{name}</h4>
